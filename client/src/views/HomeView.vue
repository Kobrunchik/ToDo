...
<template>
  ...
  <!--<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-xs-10 offset-xs-2  pb-3 pt-3" v-for="task in newtodo.tasks">
    <Tasks :id="task.id"  :date="task.date" :text="task.text" :status="task.status"></Tasks>
  </div>-->
